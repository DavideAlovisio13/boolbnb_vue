    ...
    <div class="brutalist-card" :class="{ 'brutalist-card--sponsored': sponsored }">
        ...
        <div class="hint-content do--split-children w-100 align-items-center justify-content-between pt-4">
            <div class="d-flex align-items-center justify-content-between" >
                <p class="fs-4"><strong><i class="fa-solid px-2 fa-house-user"></i></strong>{{ apartment.num_rooms }}</p>
                <p class="fs-4"><strong><i class="fa-solid px-2 fa-bed"></i></strong>{{ apartment.num_beds }}</p>
                <p class="fs-4"><strong><i class="fa-solid px-2 fa-bath"></i></strong>{{ apartment.num_bathrooms }}
                </p>
                <p class="fs-4"><strong><i class="fa-solid px-2 fa-ruler"></i></strong>{{ apartment.square_meters
                    }} m²</p>
            </div>
